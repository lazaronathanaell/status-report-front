...
DIPLOMA_PROMPT = """
    ...
    - Instruções:
        - Instruções:
            - PRIORIDADE MÁXIMA: O "nome_servidor" deve ser EXCLUSIVAMENTE o nome do ALUNO/DECLARADO como concluinte do curso.
            - NUNCA use nomes que aparecem **DEPOIS** das expressões "Documento conferido e validado por", "Assinado por", "Responsável pela conferência" ou "Secretário(a)", pois estes são nomes de validadores/assinaturas, e NÃO o nome do concluinte.
            - "titulacao" deve conter apenas o título ("LICENCIATURA PLENA", "ESPECIALIZAÇÃO", "MESTRADO" ou "DOUTORADO")
            - Curso de Pós-Graduação Lato Sensu deve ter "titulacao" igual a "ESPECIALIZAÇÃO".
            - "assinatura_eletronica" deve ter valor true se constar no contexto "Documento conferido e validado por: ".
    Exemplo 01:
        Contexto:
            O diretor geral da Faculdade de Educação e Tecnologia da Região Missioneira, no uso de suas atribuições certifica que HENRIQUE SOARES DE ALMEIDA, portador do documento de Identificação número 96021030795- S9P/CE, de nacionalidade Brasileira, natural de CARIDADE/CE, nascido no dia 24/06/1980, concluiu o Curso de Pós-Graduação Lato Sensu: ADMINISTRAÇÃO, ORIENTAÇÃO E SUPERVISÃO, com aproveitamento, a fim de que possa gozar de todos os direitos e prerrogativas legais. 
    ...
    Exemplo 02:
        Contexto:
            Declaramos, para os devidos fins, que o aluno JOELMA MOTA DE SOUSA foi aprovado(a) na DEFESA de TESE em DOUTORADO EM CIÊNCIAS SOCIAIS/PPGCS - SEROPÉDICA do Curso de DOUTORADO, no dia 16 de Dezembro de 2024 às 14:00. Documento conferido e validado por: MERILÂNDIA DO CARMO ARAGÃO - SEDUC/CREDE 6 - SOBRAL/CEGAF 6 em 27/02/2025, às 15:24 (horário local do Estado do Ceará), conforme disposto no Decreto Estadual nº 34.097, de 8 de junho de 2021.
            ...
        Resposta:
            {   
                "nome_servidor": "JOELMA MOTA DE SOUSA",
                "titulacao": "DOUTORADO",
                "assinatura_eletronica": true
            }
    """
